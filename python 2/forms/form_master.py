...
class App:
    def __init__(self):
        ...
        etiqueta_nombre = tk.Label(frame_form_fill, text="Nombre del socio", font=('Times', 10), fg="#666a88", bg='#fcfcfc', anchor="w")
        etiqueta_nombre.pack(fill=tk.X, padx=20, pady=1)
        ...
        etiqueta_cedula = tk.Label(frame_form_fill, text="Cédula", font=('Times', 10), fg="#666a88", bg='#fcfcfc', anchor="w")
        etiqueta_cedula.pack(fill=tk.X, padx=20, pady=1)
        self.cedula_socio = ttk.Entry(frame_form_fill, font=('Times', 12))
        self.cedula_socio.insert(0, "")
        self.cedula_socio.pack(fill=tk.X, padx=20, pady=1)

        etiqueta_password = tk.Label(frame_form_fill, text="Contraseña", font=('Times', 10), fg="#666a88", bg='#fcfcfc', anchor="w")
        etiqueta_password.pack(fill=tk.X, padx=20, pady=5)
        self.password = ttk.Entry(frame_form_fill, font=('Times', 12))
        self.password.pack(fill=tk.X, padx=20, pady=1)
        self.password.config(show="*")

        etiqueta_tipo_socio = tk.Label(frame_form_fill, text="Seleccione tipo de socio:", font=('Times', 10), fg="#666a88", bg='#fcfcfc', anchor="w")
        etiqueta_tipo_socio.pack(fill=tk.X, padx=20, pady=1)
        ...
        btn_afiliar.pack(fill=tk.X, padx=20, pady=5)
        ...
        btn_entrar.pack(fill=tk.X, padx=20, pady=5)
        ...
        btn_referido.pack(fill=tk.X, padx=20, pady=5)
        btn_referido.bind("<Return>", (lambda event: self.registrar_referido()))

        btn_entrar = tk.Button(frame_form_fill, text="Pagar factura", font=('Times', 10), bg='#3a7ff6', bd=0, fg="#fff", command=self.entrar)
        btn_entrar.pack(fill=tk.X, padx=20, pady=5)
        btn_entrar.bind("<Return>", (lambda event: self.entrar()))

        btn_entrar = tk.Button(frame_form_fill, text="Aumentar Fondos cuenta de socios", font=('Times', 10), bg='#3a7ff6', bd=0, fg="#fff", command=self.entrar)
        btn_entrar.pack(fill=tk.X, padx=20, pady=5)
        btn_entrar.bind("<Return>", (lambda event: self.entrar()))
    ...
    def abrir_ventana_registrar_autorizado(self, cedula_socio):
        ...
        etiqueta_cedula = tk.Label(ventana_autorizado, text="Cédula de la persona referida", font=('Times', 14), fg="#666a88", bg='#fcfcfc', anchor="w")
        etiqueta_cedula.pack(fill=tk.X, padx=20, pady=5)
        cedula_autorizado = ttk.Entry(ventana_autorizado, font=('Times', 14))
        cedula_autorizado.pack(fill=tk.X, padx=20, pady=10)
